      ...
      <main className="container mx-auto px-4 pb-12">
        ...
        {authStatus && (
          <section className="py-16">
            ...
            >
              <span className="px-4 py-2 rounded-full bg-green-900/30 text-green-400 text-sm font-medium">
                Quick Navigation
              </span>{" "}
              <h2 className="mt-4 text-3xl font-bold tracking-tight text-blue-400">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <>
                  ...
                  >
                    <div className="rounded-xl p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/10 backdrop-blur-sm border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-500/10">
                      ...
                      <h3 className="text-lg font-bold mb-2 group-hover:text-purple-400 transition-colors duration-300">
                        Faculty Batches
                      </h3>
                      <p className="text-gray-400 text-sm">
              ...
              >
                <div className="rounded-xl p-6 bg-gradient-to-br from-green-500/10 to-green-600/10 backdrop-blur-sm border border-green-500/20 hover:border-green-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-green-500/10">
                  ...
                  <h3 className="text-lg font-bold mb-2 group-hover:text-green-400 transition-colors duration-300">
                    Problem Dashboard
                  </h3>
                  <p className="text-gray-400 text-sm">
              ...
              >
                <div className="rounded-xl p-6 bg-gradient-to-br from-indigo-500/10 to-indigo-600/10 backdrop-blur-sm border border-indigo-500/20 hover:border-indigo-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/10">
                  ...
                  <h3 className="text-lg font-bold mb-2 group-hover:text-indigo-400 transition-colors duration-300">
                    Submission History
                  </h3>
                  <p className="text-gray-400 text-sm">
              ...
              >
                <div className="rounded-xl p-6 bg-gradient-to-br from-pink-500/10 to-pink-600/10 backdrop-blur-sm border border-pink-500/20 hover:border-pink-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-500/10">
                  ...
                  <h3 className="text-lg font-bold mb-2 group-hover:text-pink-400 transition-colors duration-300">
                    Profile
                  </h3>
                  <p className="text-gray-400 text-sm">
                ...
                <>
                  ...
                  >
                    <div className="rounded-xl p-6 bg-gradient-to-br from-red-500/10 to-red-600/10 backdrop-blur-sm border border-red-500/20 hover:border-red-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-500/10">
                      ...
                      <h3 className="text-lg font-bold mb-2 group-hover:text-red-400 transition-colors duration-300">
                        Admin Panel
                      </h3>
                      <p className="text-gray-400 text-sm">
                  ...
                  >
                    <div className="rounded-xl p-6 bg-gradient-to-br from-teal-500/10 to-teal-600/10 backdrop-blur-sm border border-teal-500/20 hover:border-teal-400/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-teal-500/10">
                      ...
                      <h3 className="text-lg font-bold mb-2 group-hover:text-teal-400 transition-colors duration-300">
                        Batch Management
                      </h3>
                      <p className="text-gray-400 text-sm">
        ...
        <section className="py-20">
          ...
          >
            <span className="px-4 py-2 rounded-full bg-blue-900/30 text-blue-400 text-sm font-medium">
              Why Choose Our Platform?
            </span>{" "}
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-blue-600">
        ...
        <section className="py-20">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="px-4 py-2 rounded-full bg-purple-900/30 text-purple-400 text-sm font-medium">
              Simple Process
            </span>{" "}
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-purple-400">
              How It Works
            </h2>
            <p className="mt-3 max-w-2xl mx-auto text-gray-400">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-blue-600 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center border border-blue-500/30">
              ...
              {/* Connecting line */}
              <div className="hidden md:block absolute top-10 left-3/4 w-1/2 h-0.5 bg-blue-500/50"></div>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center relative"
            >
              <div className="bg-green-600 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center border border-green-500/30">
              ...
              {/* Connecting line */}
              <div className="hidden md:block absolute top-10 left-3/4 w-1/2 h-0.5 bg-green-500/50"></div>
            </motion.div>
            ...
            >
              <div className="bg-purple-600 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center border border-purple-500/30">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["C++", "Java", "Python", "JavaScript", "C"].map((lang, index) => (
              <motion.div
                ...
                className="px-6 py-3 bg-gray-800 rounded-full border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1"
              >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="group px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-xl text-lg font-semibold shadow-lg hover:shadow-blue-500/20 transition-all duration-300 flex items-center justify-center gap-2"
      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-center">
        ...
        >
          <div className="text-center md:text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-blue-600 mb-4 leading-tight tracking-tight">
              Code Without Limits <br className="hidden sm:inline" />
              <span className="relative text-white">
                Think. Build. Dominate.
                <span className="absolute -bottom-1 left-0 w-full h-1.5 bg-blue-400 rounded-full" />
              </span>
            </h1>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Footer Text */}
        <p className="text-gray-600 text-sm">Coding Platform - KDPIT</p>
