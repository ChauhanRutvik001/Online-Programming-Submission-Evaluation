...
const AdminStudentRegister = () => {
  ...
  return (
    <>
      <div className="relative min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white p-0 md:p-4">
        {/* Header Section */}
        <nav className="w-full bg-gradient-to-r from-gray-900 via-indigo-900 to-gray-800  px-4  flex items-center justify-between z-40"></nav>
        <Sidebar />
        <div className="flex-1 md:ml-60 p-0 md:p-4 mt-16">
                ...
                <ul className="text-gray-300 space-y-4">
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      Should include the enrollment year and department code
                      (e.g., 22it015).
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      Students will be prompted to change their password upon
                      first login.
                    </span>
                  </li>
                </ul>
