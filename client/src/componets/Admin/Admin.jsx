  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        if (response.data && response.data.success) {          setStats({
                ...
                <>
                  ...
                  <div className="group bg-gradient-to-br from-amber-900/90 to-amber-800/80 rounded-xl shadow-lg overflow-hidden relative hover:shadow-amber-700/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="px-6 py-5 relative z-10">
                      <div className="flex justify-between items-start">
                        <div>
                          <p className="text-amber-300 text-sm font-medium">Total Problems</p>
                          <h3 className="mt-1 text-4xl font-bold text-white">{stats.problems}</h3>
                        </div>
                ...
                <div className="p-6 relative z-10 max-h-[400px] overflow-y-auto custom-scrollbar">
                  {loading ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <div className="text-gray-500 text-sm">Activity will appear here when users interact with the system</div>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-4">
                      {recentActivity.map(activity => (
                        <div key={activity.id} className="flex items-start gap-3 p-4 bg-gray-800/50 rounded-lg hover:bg-gray-800/70 transition-colors duration-200">
